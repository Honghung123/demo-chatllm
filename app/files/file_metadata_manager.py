...
def add_metadata(file_name: str, author: str, roles: list) -> None:
...
def update_metadata(file_name: str, author: str, roles: list) -> None:
    """
        Update metadata for a file.
        How to use:
        update_metadata("file1.pdf", author="new_author", date=datetime.now().isoformat)
        or
        update_metadata("file1.pdf", size=5000000, roles=["admin", "user"])
    """
    ...
    metadatas[file_name]['author'] = author
